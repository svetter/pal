 ...
 */
AssociativeTable::AssociativeTable(Database& db, QString name, QString uiName, PrimaryKeyColumn& foreignKeyColumn1, PrimaryKeyColumn& foreignKeyColumn2) :
	Table(db, name, uiName, true),
