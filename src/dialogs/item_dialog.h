...
void populateItemCombo(NormalTable* table, const ValueColumn* displayAndSortColumn, bool sortAsString, QComboBox* combo, QList<ValidItemID>& idList, QString overrideFirstLine = QString(), const ForeignKeyColumn* filterColumn = nullptr, ItemID filterID = ItemID(ItemTypeNone));
